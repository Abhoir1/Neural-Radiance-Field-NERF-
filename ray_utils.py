...
def get_rays_from_pixels(xy_grid, image_size, camera):
    ...
    world_space_points_shape = world_space_points.shape[0]
    rays_o = camera.get_camera_center().expand(world_space_points_shape, -1)


    # TODO (1.3): Get ray directions as image_plane_points - rays_o
    rays_d = F.normalize(world_space_points - rays_o)
